...
env = EnvironmentOptions(
    ...
    sim_folder='tae_tp_sonic', 
    save_step=8, max_runtime=2840)

# units
base_units = BaseUnits(n=0.2)

# time stepping
time_opts = Time(dt=0.25, Tend=1000., split_algo='Strang')
...
filter_params = FilterParameters(use_filter="three_point",)
