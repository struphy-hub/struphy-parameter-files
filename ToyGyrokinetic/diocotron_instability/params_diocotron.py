...
model.kinetic_ions.set_sorting_boxes(boxes_per_dim=(32,32,1), do_sort=True, box_bufsize=0.8)

# density binning
eta_bin = BinningPlot(slice='e1_e2', n_bins= (32,32), ranges= ((0.0, 1.0), (0.0,1.0)))
